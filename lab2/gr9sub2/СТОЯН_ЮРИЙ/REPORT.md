...
**ЦЕЛЬ:**
Практика работы с процессами в Linux,реализация супервизора для управления воркерами с обработкой сигналов,исследование влияния параметров планирования (nice levels и CPU affinity) на распределение процессорного времени между процессами в Linux
Для установки пакетов из requirements используем команду 'pip install -r requirements.txt'.
