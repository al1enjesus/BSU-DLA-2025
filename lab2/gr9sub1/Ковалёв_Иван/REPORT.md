...
#### 6. Демонстрация действий и комментарии с выводами

##### 6.1 Запуск супервизора
...
##### 6.2 Переключение режимов — SIGUSR1 (LIGHT)
...
##### 6.3 Переключение режимов — SIGUSR2 (HEAVY)
...
##### 6.5 Перезагрузка конфигурации — SIGHUP (graceful reload)
...
[SUP-debug] exec args: ./worker --id 0 --config /home/vanya/BSU-DLA-2025/lab2/gr9sub1/Ковалёв_Иван/src/config.cfg --nice 0 --affinity 0
[SUP] started worker id=1 pid=7340
[SUP-debug] exec args: ./worker --id 1 --config /home/vanya/BSU-DLA-2025/lab2/gr9sub1/Ковалёв_Иван/src/config.cfg --nice 10 --affinity 1
[SUP] started worker id=2 pid=7341
[SUP-debug] exec args: ./worker --id 2 --config /home/vanya/BSU-DLA-2025/lab2/gr9sub1/Ковалёв_Иван/src/config.cfg --nice 0 --affinity 2,3
[SUP] started worker id=3 pid=7342
[SUP] monitor loop enter
[SUP-debug] exec args: ./worker --id 3 --config /home/vanya/BSU-DLA-2025/lab2/gr9sub1/Ковалёв_Иван/src/config.cfg --nice 10 --affinity 0
...
[SUP-debug] exec args: ./worker --id 2 --config /home/vanya/BSU-DLA-2025/lab2/gr9sub1/Ковалёв_Иван/src/config.cfg --nice 0 --affinity 0
[SUP] started worker id=3 pid=9755
[SUP] monitor loop enter
[SUP-debug] exec args: ./worker --id 3 --config /home/vanya/BSU-DLA-2025/lab2/gr9sub1/Ковалёв_Иван/src/config.cfg --nice 10 --affinity 1
