...
static int __init hello_init(void)
{
    if (strcmp(message, "default message") == 0) {
        printk(KERN_INFO "Hello from Амир module!\n");
    } else {
...
{
    if (strcmp(message, "default message") == 0) {
        printk(KERN_INFO "Goodbye from Амир module!\n");
    } else {
...
[ 3018.372640] Hello from Амир module!
```
...
[ 5661.362696] Hello from Амир module!
[ 5674.644410] Goodbye from Амир module!
