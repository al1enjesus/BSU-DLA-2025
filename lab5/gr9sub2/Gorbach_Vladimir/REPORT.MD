...
1.  При загрузке (`insmod`) выводит в системный журнал сообщение "Hello from [Gorbach_Vladimir] module!".
2.  При выгрузке (`rmmod`) выводит сообщение "Goodbye from [Gorbach_Vladimir] module!".
...
make[2]: Entering directory '/mnt/hgfs/BSU-DLA-2025/lab5/gr9sub2/Gorbach_Vladimir/src'
  CC [M]  hello_module.o
...
make[2]: Leaving directory '/mnt/hgfs/BSU-DLA-2025/lab5/gr9sub2/Gorbach_Vladimir/src'
...
```bash
filename:       /mnt/hgfs/BSU-DLA-2025/lab5/gr9sub2/Gorbach_Vladimir/src/hello_module.ko
version:        1.0
...
```bash
[ 1509.857484] hello_module: Hello from Gorbach Vladimir module!
```
...
```bash
[ 1627.157076] hello_module: Goodbye from Gorbach Vladimir module!
```
...
```bash
[ 2114.491552] hello_module: Goodbye from Gorbach Vladimir module!
```
---
...
make -C /lib/modules/6.14.0-33-generic/build M=/mnt/hgfs/BSU-DLA-2025/lab5/gr9sub2/Gorbach_Vladimir/src modules
make[1]: Entering directory '/usr/src/linux-headers-6.14.0-33-generic'
make[2]: Entering directory '/mnt/hgfs/BSU-DLA-2025/lab5/gr9sub2/Gorbach_Vladimir/src'
  CC [M]  hello_module.o
  CC [M]  proc_module.o
...
```bash
filename:       /mnt/hgfs/BSU-DLA-2025/lab5/gr9sub2/Gorbach_Vladimir/src/proc_module.ko
version:        1.1
...
```bash
filename:       /mnt/hgfs/BSU-DLA-2025/lab5/gr9sub2/Gorbach_Vladimir/src/sys_stats_module.ko
version:        1.1
