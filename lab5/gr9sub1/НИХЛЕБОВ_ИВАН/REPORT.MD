...
1.  При загрузке (`insmod`) выводит в системный журнал сообщение "Hello from [Nihlebov_Ivan] module!".
2.  При выгрузке (`rmmod`) выводит сообщение "Goodbye from [Nihlebov_Ivan] module!".
...
make[2]: Entering directory '/mnt/hgfs/BSU-DLA-2025/lab5/gr9sub1/НИХЛЕБОВ_ИВАН/src'
  CC [M]  hello_module.o
...
make[2]: Leaving directory '/mnt/hgfs/BSU-DLA-2025/lab5/gr9sub1/НИХЛЕБОВ_ИВАН/src'
...
```bash
filename:       /mnt/hgfs/BSU-DLA-2025/lab5/gr9sub1/НИХЛЕБОВ_ИВАН/src/hello_module.ko
version:        1.0
description:    Task A: A simple Hello World kernel module with a parameter.
author:         Nihlebov_Ivan
license:        GPL
...
```bash
[ 1509.857484] hello_module: Hello from Nihlebov Ivan module!
```
...
```bash
[ 1627.157076] hello_module: Goodbye from Nihlebov Ivan module!
```
...
```bash
[ 2114.491552] hello_module: Goodbye from Nihlebov Ivan module!
```
...
make -C /lib/modules/6.14.0-33-generic/build M=/mnt/hgfs/BSU-DLA-2025/lab5/gr9sub1/НИХЛЕБОВ_ИВАН/src modules
make[1]: Entering directory '/usr/src/linux-headers-6.14.0-33-generic'
make[2]: Entering directory '/mnt/hgfs/BSU-DLA-2025/lab5/gr9sub1/НИХЛЕБОВ_ИВАН/src'
  CC [M]  hello_module.o
  CC [M]  proc_module.o
...
```bash
filename:       /mnt/hgfs/BSU-DLA-2025/lab5/gr9sub1/НИХЛЕБОВ_ИВАН/src/proc_module.ko
version:        1.1
description:    Task B: /proc file with read/write support (thread-safe).
author:         Nihlebov Ivan
license:        GPL
...
```bash
filename:       /mnt/hgfs/BSU-DLA-2025/lab5/gr9sub1/НИХЛЕБОВ_ИВАН/src/sys_stats_module.ko
version:        1.1
