...
[SPY] dup(2)
total 44
drwxrwxr-x 6 vova vova 4096 Oct 13 09:24 .
drwxrwxr-x 3 vova vova 4096 Oct 13 08:35 ..
drwxrwxr-x 2 vova vova 4096 Oct 13 09:31 bin
drwxrwxr-x 2 vova vova 4096 Oct 13 09:31 lib
drwxrwxr-x 2 vova vova 4096 Oct 13 09:25 logs
-rw-rw-r-- 1 vova vova  734 Oct 13 08:58 Makefile
-rw-rw-r-- 1 vova vova  947 Oct 13 07:59 README.md
-rw-rw-r-- 1 vova vova 8901 Oct 13 09:30 REPORT.md
drwxrwxr-x 2 vova vova 4096 Oct 13 09:12 src
```
...
vova:x:1000:1000:vova:/home/vova:/bin/bash
...
--------------------------------------------------------------------------------------
| dummy() userspace         | 6           | 1.82           | 1.00x                   |
| getpid()                  | 596         | 180.61         | 99.33x                  |
| open("file_name")+close() | 34942       | 10588.48       | 5823.67x                |
| gettimeofday() vDSO       | 76          | 23.03          | 12.67x                  |
--------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------
| dummy() userspace         | 6           | 1.82           | 1.00x                   |
| getpid()                  | 585         | 177.27         | 97.50x                  |
| open("file_name")+close() | 35278       | 10690.30       | 5879.67x                |
| gettimeofday() vDSO       | 77          | 23.33          | 12.83x                  |
--------------------------------------------------------------------------------------
Note: CPU frequency is set to 3.30 GHz. Please adjust if needed.
```
...
## Использование AI
AI использовался для проверки работы программ и первичной генерации отчёта.