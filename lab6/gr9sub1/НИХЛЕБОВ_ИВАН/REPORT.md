...
```
(venv-lab6) /BSU-DLA-2025/lab6/gr9sub1/НИХЛЕБОВ_ИВАН$ ./benchmark.sh /tmp/source native
...
(venv-lab6) /BSU-DLA-2025/lab6/gr9sub1/НИХЛЕБОВ_ИВАН$ ./benchmark.sh /tmp/fuse fuse
...
Очистка...
--- Тестирование завершено ---
(venv-lab6) d/BSU-DLA-2025/lab6/gr9sub1/НИХЛЕБОВ_ИВАН$ ./benchmark.sh /tmp/fuse fuse
--- Тестирование директории: /tmp/fuse (Тип: fuse) ---
Подготовка...
Тест 1: Пропускная способность (dd)...
  - Размер файла: 1MB
