...
```
total 20
drwxrwxr-x 3 vanya vanya 4096 Nov 27 19:30 .
drwxr-xr-x 3 root  root  4096 Nov 27 14:24 ..
-rw-rw-r-- 1 vanya vanya   30 Nov 27 19:22 file2.txt
drwxrwxr-x 2 vanya vanya 4096 Nov 27 19:20 subdir
-rw-rw-r-- 1 vanya vanya   31 Nov 27 19:20 test.txt
```
Вывод 2:
```
...
```
vanya@vanya-Legion-5-15ACH6:~/BSU-DLA-2025/lab6/gr9sub1/Ковалёв_Иван/src$ ls -la /tmp/source/
total 20
drwxrwxr-x  3 vanya vanya 4096 Nov 27 20:03 .
drwxrwxrwt 23 root  root  4096 Nov 27 19:53 ..
-rw-rw-r--  1 vanya vanya   47 Nov 27 19:58 file2.txt
drwxrwxr-x  2 vanya vanya 4096 Nov 27 19:20 subdir
-rw-rw-r--  1 vanya vanya   31 Nov 27 19:20 test.txt

vanya@vanya-Legion-5-15ACH6:~/BSU-DLA-2025/lab6/gr9sub1/Ковалёв_Иван/src$ tree -la /tmp/source/
/tmp/source/
├── file2.txt
├── subdir
│   └── nested.txt
...
vanya@vanya-Legion-5-15ACH6:~/BSU-DLA-2025/lab6/gr9sub1/Ковалёв_Иван/src$ ls -la /mnt/fuse/total 20
drwxrwxr-x 3 vanya vanya 4096 Nov 27 20:03 .
drwxr-xr-x 3 root  root  4096 Nov 27 14:24 ..
-rw-rw-r-- 1 vanya vanya   47 Nov 27 19:58 file2.txt
drwxrwxr-x 2 vanya vanya 4096 Nov 27 19:20 subdir
...
vanya@vanya-Legion-5-15ACH6:~/BSU-DLA-2025/lab6/gr9sub1/Ковалёв_Иван/src$ tree -la /mnt/fuse/
/mnt/fuse/
├── file2.txt
├── subdir
│   └── nested.txt
...
2 directories, 3 files
vanya@vanya-Legion-5-15ACH6:~/BSU-DLA-2025/lab6/gr9sub1/Ковалёв_Иван/src$ cat /tmp/source/test.txt
Hello FUSE - this is test file

vanya@vanya-Legion-5-15ACH6:~/BSU-DLA-2025/lab6/gr9sub1/Ковалёв_Иван/src$ cat /mnt/fuse/test.txt
Hello FUSE - this is test file

vanya@vanya-Legion-5-15ACH6:~/BSU-DLA-2025/lab6/gr9sub1/Ковалёв_Иван/src$ cat /tmp/source/file2.txt
Another file
Appended content
Appended content

vanya@vanya-Legion-5-15ACH6:~/BSU-DLA-2025/lab6/gr9sub1/Ковалёв_Иван/src$ cat /mnt/fuse/file2.txt
Another file
Appended content
Appended content
```
...
```
total 28
drwxrwxr-x 3 vanya vanya 4096 Nov 28 02:32 .
drwxr-xr-x 5 root  root  4096 Nov 28 02:30 ..
-rw-rw-r-- 1 vanya vanya   13 Nov 27 23:50 file2.txt
-rw-rw-r-- 1 vanya vanya    5 Nov 28 02:32 file.txt
-rw-rw-r-- 1 vanya vanya   38 Nov 27 23:58 newfile.txt
-r--r--r-- 1 root  root   126 Jan  1  1970 .stats
drwxrwxr-x 2 vanya vanya 4096 Nov 27 23:50 subdir
-rw-rw-r-- 1 vanya vanya   31 Nov 27 23:50 test.txt
```
Вывод 2:
```
...
**Анализ результатов**
```
vanya@vanya-Legion-5-15ACH6:~/BSU-DLA-2025/lab6/gr9sub1/Ковалёв_Иван/src$ make run_benchmarks
