...
static void show_help(const char *progname) {
    ...
    printf("\n");
    printf("ROT13 Encryption Filesystem:\n");
    printf("- Файлы на диске хранятся зашифрованными (ROT13)\n");
    printf("- При чтении автоматически расшифровываются\n");
    printf("- При записи автоматически шифруются\n");
    printf("\n");
    ...
    printf("    echo \"Hello World\" > /mnt/fuse/secret.txt\n");
    printf("    cat /tmp/source/secret.txt    # Увидите: \"Uryyb Jbeyq\"\n");
    printf("    cat /mnt/fuse/secret.txt      # Увидите: \"Hello World\"\n");
    printf("\n");
}
...
int main(int argc, char *argv[]) {
    ...
    printf("ROT13 Encryption FUSE filesystem\n");
    printf("Source directory: %s\n", base_path);
    printf("Mount point: %s\n", mount_point);
    printf("Шифрование: ROT13 (сдвиг на 13 позиций в алфавите)\n");
    ...
    // Запускаем FUSE
    ret = fuse_main(args.argc, args.argv, &rot13_operations, NULL);
