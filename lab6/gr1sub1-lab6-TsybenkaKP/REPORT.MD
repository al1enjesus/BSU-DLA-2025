...
```bash
kirill@kirill-VirtualBox:~/Desktop/BSU-DLA-2025/lab6/gr1sub1/TsybenkaKP$  make
...
```bash
kirill@kirill-VirtualBox:~/Desktop/BSU-DLA-2025/lab6/gr1sub1/TsybenkaKP$  ls -la /tmp/source
total 12
...
```bash
kirill@kirill-VirtualBox:~/Desktop/BSU-DLA-2025/lab6/gr1sub1/TsybenkaKP$  sudo mkdir -p /tmp/source /tmp/mount
```
...
```text
kirill@kirill-VirtualBox:~/Desktop/BSU-DLA-2025/lab6/gr1sub1/TsybenkaKP$  ./myfuse /tmp/source /tmp/mount --mode=passthrough -f
Mounting /tmp/source at /tmp/mount (mode=passthrough)
Ignoring invalid max threads value 4294967295 > max (100000).
[2025-11-26 22:55:42] GETATTR: /.Trash (res=-2)
[2025-11-26 22:55:42] GETATTR: /.Trash-1000 (res=-2)
